              ...
              <table class="table table-striped table-valign-middle">
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td>4.43</td>
                    <td>400</td>
                    <td><a href="{{route('home.todo-list')}}">50%</a></td>
                    <td><a href="{{route('home.todo-list')}}">30%</a></td>
                    <td><a href="{{route('home.todo-list')}}">18%</a></td>
                    <td><a href="{{route('home.todo-list')}}">0</a></td>
                    <td><a href="{{route('home.todo-list')}}">4.43</a></td>
                    <td><a href="{{route('home.todo-list')}}">400</a></td>
                    <td><a href="{{route('home.todo-list')}}">10%</a></td>
                    <td><a href="{{route('home.todo-list')}}">6%</a></td>
                    <td><a href="{{route('home.todo-list')}}">2%</a></td>
                    <td><a href="{{route('home.todo-list')}}">0%</a></td>
                    <td><a href="{{route('home.todo-list')}}">0%</a></td>
                    <td><a href="{{route('home.todo-list')}}">0%</a></td>
