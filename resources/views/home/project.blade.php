      ...
      <div class="container-fluid">
        ...
        <div class="card">
          ...
          <div class="card-body table-responsive d-flex flex-column justify-content-center">
            <h2 id="toDoTitle" class="text-center mt-2 mb-2">यो प्रोजेक्ट गर्न कि नगर्ने</h2>
            <div id="toDoAction" class="mx-auto mt-4">
              <button class="btn btn-primary mb-3" onclick="projectConfirm()">
                गर्न
              </button>
              <a href="{{route('home.project-detail')}}" class="btn btn-primary mb-3">
                नगर्ने
              </a>
            </div>

            <div id="ifToDo" class="d-none mx-auto mt-4">
              <div class="form-group">
                <label for="name">
                  प्रोजेक्ट गर्न कार्यालय
                </label>
                <input type="text" id="inputName" class="form-control" value="">
              </div>
              <div class="form-group">
                <label for="name">
                  जिम्मेवार व्यक्तिको नाम
                </label>
                <input type="text" id="inputName" class="form-control" value="">
              </div>
              <div class="form-group">
                <label for="name">
                  जिम्मेवार व्यक्तिको पद
                </label>
                <input type="text" id="inputName" class="form-control" value="">
              </div>
              <button id="whoDoesIt" type="submit" class="btn btn-primary" onclick="doerSubmit()">पेश गर्नुहोस्</button>
            </div>
          </div>
        </div>
      </div><!-- /.container-fluid -->
...
<script>
  function projectConfirm() {
    document.getElementById("toDoTitle").textContent = "यो प्रोजेक्ट कसले गर्न";
    document.getElementById("toDoAction").classList.add("d-none");
    document.getElementById("ifToDo").classList.remove("d-none");
  }
