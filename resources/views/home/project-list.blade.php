  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="mb-2">प्रोजेक्ट सूची</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
        ...
        <div class="card">
          <div class="card-body table-responsive">
            <table class="table table-striped table-valign-middle border-top">
              ...
              <tr>
                <td>१</td>
                <td>मन्त्रालय प्रोजेक्ट</td>
                <td>
                  <a href="{{route('home.project-detail')}}" class="btn btn-primary">
                    अर्को
              ...
              <tr>
                <td>२</td>
                <td>
                  सुदूर पश्चिम प्रादेश सरकार प्रोजेक्ट
                </td>
                <td>
                  <a href="{{route('home.project-detail')}}" class="btn btn-primary">
                    अर्को
