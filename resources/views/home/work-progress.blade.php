      ...
      <nav class="main-header navbar navbar-expand navbar-white navbar-light">
        ...
        <ul class="navbar-nav">
          <ul class="navbar-nav">
            ...
            <li class="nav-item">
              <a href="action-progress.html" class="nav-link">
                <p>कार्य प्रगति</p>
              </a>
            </li>
          </ul>
                  ...
                  <div class="modal-dialog">
                    <div class="modal-content">
                      ...
                      <div class="modal-body">
                        ...
                        >
                          <h6 class="modal-title m-2">Remarks</h6>
                          <textarea class="m-2">
The remarks appears here</textarea
                          >
                        </div>
                        <!-- /.content -->
                        ...
                        <div
                          id="textHolder"
                          class="card card-outline card-info p-2 mb-0 mt-3"
                        >
                          <!-- /.card-header -->
                          <button
                            id="btnComment"
                          ...
                          <textarea id="summernote" class="m-2 d-none">
